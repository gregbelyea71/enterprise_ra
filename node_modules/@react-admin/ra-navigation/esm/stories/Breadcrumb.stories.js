...
var SongListAside = function () { return (React.createElement(Switch, null,
    ...
    React.createElement(Route, { path: "/songs/:id/show", render: function (routeProps) { return (React.createElement(SongShow, { id: routeProps.match.params.id, resource: "songs", basePath: "/songs" })); } }),
    React.createElement(Route, { path: "/songs/:id", render: function (routeProps) { return (React.createElement(SongEdit, { id: routeProps.match.params.id, resource: "songs", basePath: "/songs" })); } }))); };
...
export var Basic = function (props) { return (React.createElement(Admin, __assign({ history: createMemoryHistory(), dataProvider: dataProvider, i18nProvider: i18nProvider, layout: MyLayout, dashboard: function (props) { return (React.createElement(Dashboard, __assign({ breadcrumb: React.createElement(MyBreadcrumb, { hasDashboard: true }) }, props))); } }, props),
