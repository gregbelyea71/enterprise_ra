...
var i18nProvider = ra_i18n_polyglot_1.default(function () { return ra_language_english_1.default; });
...
var SongListAside = function () { return (react_1.default.createElement(react_router_dom_1.Switch, null,
    ...
    react_1.default.createElement(react_router_dom_1.Route, { path: "/songs/:id/show", render: function (routeProps) { return (react_1.default.createElement(SongShow, { id: routeProps.match.params.id, resource: "songs", basePath: "/songs" })); } }),
    react_1.default.createElement(react_router_dom_1.Route, { path: "/songs/:id", render: function (routeProps) { return (react_1.default.createElement(SongEdit, { id: routeProps.match.params.id, resource: "songs", basePath: "/songs" })); } }))); };
...
var Basic = function (props) { return (react_1.default.createElement(react_admin_1.Admin, __assign({ history: history_1.createMemoryHistory(), dataProvider: dataProvider_1.default, i18nProvider: i18nProvider, layout: MyLayout, dashboard: function (props) { return (react_1.default.createElement(Dashboard, __assign({ breadcrumb: react_1.default.createElement(MyBreadcrumb, { hasDashboard: true }) }, props))); } }, props),
...
var BasicNoHome = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider_1.default, layout: MyLayout },
...
var BasicCustomHome = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider_1.default, layout: MyLayout },
