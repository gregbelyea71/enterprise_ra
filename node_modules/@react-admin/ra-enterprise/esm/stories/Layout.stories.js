...
import { Resource, SimpleForm, Datagrid, TextField, TextInput, SimpleShowLayout, mergeTranslations, } from 'react-admin';
...
var ArtistsFilters = [
    React.createElement(TextInput, { key: "search", label: "Search", source: "q" }),
    React.createElement(TextInput, { key: "name", source: "name" }),
    React.createElement(TextInput, { key: "firstname", source: "firstname" }),
];
var ArtistList = function (props) { return (React.createElement(List, __assign({}, props, { filters: ArtistsFilters, sort: { field: 'id', order: 'DESC' } }),
