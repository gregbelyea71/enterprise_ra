...
var EditableRow = function (_a) {
    ...
    var _d = react_admin_1.useSaveModifiers({
        onFailure: defaultOnFailure,
        onSuccess: defaultOnSuccess,
    }), onSuccessRef = _d.onSuccessRef, setOnSuccess = _d.setOnSuccess, onFailureRef = _d.onFailureRef, setOnFailure = _d.setOnFailure, transformRef = _d.transformRef, setTransform = _d.setTransform;
    ...
    return (React.createElement(EditRowContext_1.EditRowContext.Provider, { value: rowContext }, isEdit ? (React.createElement(react_admin_1.SaveContextProvider, { value: saveContext }, react_1.cloneElement(form, __assign({ id: id, quitEditMode: closeEditMode, resource: resource, record: record, basePath: basePath, save: save, saving: saving, undoable: undoable }, rest)))) : (React.createElement(react_admin_1.DatagridRow, __assign({ resource: resource, id: id, record: record, basePath: basePath }, rest, { className: classes.td, onClick: rowClick === 'edit'
            ? handleClick
