...
var DeleteWithConfirmIconButton = function (_a) {
    var basePath = _a.basePath, className = _a.className, _b = _a.confirmTitle, confirmTitle = _b === void 0 ? 'ra.message.delete_title' : _b, _c = _a.confirmContent, confirmContent = _c === void 0 ? 'ra.message.delete_content' : _c, _d = _a.label, label = _d === void 0 ? 'ra.action.delete' : _d, mutationMode = _a.mutationMode, record = _a.record, resource = _a.resource, _e = _a.redirect, redirectTo = _e === void 0 ? 'list' : _e;
    var _f = react_admin_1.useDeleteWithConfirmController({
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(core_1.Tooltip, { title: translatedLabel },
            react_1.default.createElement(core_1.IconButton, { "aria-label": translatedLabel, onClick: handleDialogOpen, className: classnames_1.default('ra-delete-button', className), key: "button", size: "small" },
