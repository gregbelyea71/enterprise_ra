...
var Basic = function () { return (react_1.default.createElement(src_1.Admin, { dataProvider: dataProvider, history: history_1.createMemoryHistory() },
...
var WithDashboard = function () { return (react_1.default.createElement(src_1.Admin, { dashboard: Dashboard, dataProvider: dataProvider, history: history_1.createMemoryHistory() },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistList, edit: ArtistEdit }),
    react_1.default.createElement(react_admin_1.Resource, { name: "events", list: react_admin_1.ListGuesser }),
    react_1.default.createElement(react_admin_1.Resource, { name: "performances", list: react_admin_1.ListGuesser }))); };
...
var WithTree = function () { return (react_1.default.createElement(src_1.Admin, { dashboard: Dashboard, dataProvider: dataProvider, history: history_1.createMemoryHistory() },
    react_1.default.createElement(react_admin_1.Resource, { name: "categories", list: CategoriesList }))); };
exports.WithTree = WithTree;
var WithResourceLabel = function () { return (react_1.default.createElement(src_1.Admin, { dataProvider: dataProvider, history: history_1.createMemoryHistory() },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", options: { label: 'custom' }, list: ArtistList, edit: ArtistEdit }),
    react_1.default.createElement(react_admin_1.Resource, { name: "events", list: react_admin_1.ListGuesser }),
    react_1.default.createElement(react_admin_1.Resource, { name: "performances", list: react_admin_1.ListGuesser }))); };
exports.WithResourceLabel = WithResourceLabel;
var darkTheme = {
    palette: {
        type: 'dark',
        primary: {
...
var WithCustomizedThemes = function () { return (react_1.default.createElement(src_1.Admin, { dataProvider: dataProvider, history: history_1.createMemoryHistory(), lightTheme: lightTheme, darkTheme: darkTheme },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistList, edit: ArtistEdit }))); };
exports.WithCustomizedThemes = WithCustomizedThemes;
...
var WithCustomMenu = function () { return (react_1.default.createElement(src_1.Admin, { dataProvider: dataProvider, history: history_1.createMemoryHistory(), layout: CustomLayout, theme: { overrides: { RaSidebar: null } } },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistList, edit: ArtistEdit }))); };
exports.WithCustomMenu = WithCustomMenu;
