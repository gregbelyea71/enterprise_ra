...
var ListToolbar = function (props) {
    ...
    return Array.isArray(filters) ? (React.createElement(react_admin_1.FilterContext.Provider, { value: filters },
        ...
        React.createElement(FilterForm_1.FilterForm, null))) : (React.createElement(React.Fragment, null,
        React.createElement(core_1.Toolbar, { className: classes.toolbar }, actions &&
...
ListToolbar.propTypes = __assign(__assign({}, react_admin_1.ListToolbar.propTypes), { breadcrumb: prop_types_1.default.element });
