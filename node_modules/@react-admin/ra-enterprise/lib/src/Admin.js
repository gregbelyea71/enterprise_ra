...
var Admin = function (props) {
    ...
    return (React.createElement(ra_preferences_1.PreferencesBasedThemeProvider, { themeFromType: themes_1.buildThemeFromTypeMethod(merge_1.default({}, ra_navigation_1.theme, theme), lightTheme, darkTheme) },
        React.createElement(react_admin_1.Admin, __assign({ i18nProvider: i18nProvider || i18nProvider_1.buildI18nProvider(), customReducers: mergedCustomReducers }, rest))));
};
exports.Admin = Admin;
