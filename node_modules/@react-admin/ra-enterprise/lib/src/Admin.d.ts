...
export declare const Admin: {
    ...
    defaultProps: {
        layout: {
            (props: import("./layout").LayoutProps): JSX.Element;
            defaultProps: {
                appBar: {
                    (props: import("./layout").AppBarProps): JSX.Element;
                    defaultProps: {
                        languages: any[];
                    };
                };
                sidebar: (props: import("react-admin").SidebarProps) => JSX.Element;
                menu: {
                    ({ hasDashboard, ...props }: import("./layout").MenuProps): JSX.Element;
                    propTypes: {
                        hasDashboard: import("prop-types").Requireable<boolean>;
                    };
                };
                tours: {};
            };
