 ...
 *
 */
var buildThemeFromTypeMethod = function (theme, lightTheme, darkTheme) {
    return function (type) {
        return merge_1.default({}, theme, type === 'dark' ? exports.defaultDarkTheme : exports.defaultLightTheme, type === 'dark' ? darkTheme || {} : lightTheme || {});
    };
};
exports.buildThemeFromTypeMethod = buildThemeFromTypeMethod;
var overrides = {
    RaTopToolbar: {
        root: {
            alignItems: 'center',
