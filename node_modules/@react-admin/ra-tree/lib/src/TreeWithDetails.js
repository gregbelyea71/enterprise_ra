 ...
 * );
 */
var TreeWithDetails = function (_a) {
    ...
    return (React.createElement("div", { className: classes.container },
        React.createElement("div", { className: classes.cardTree },
            React.createElement(core_1.Card, null,
                React.createElement(core_1.CardContent, null,
                    React.createElement(Tree_1.Tree, __assign({ treeData: tree, onDrop: handleDrop, onExpand: handleExpand, onClick: handleClick, expandedKeys: expandedKeys, selectedKeys: defaultSelectedKeys, showLine: showLine, nodeActions: react_1.cloneElement(nodeActions, __assign({ basePath: basePath, resource: resource }, nodeActions.props)), loadData: lazy ? handleLoadData : undefined }, sanitizeRestProps(props))),
        ...
        React.createElement("div", { className: classes.actionCard },
            React.createElement(react_router_dom_1.Switch, null,
                ...
                React.createElement(react_router_dom_1.Route, { path: basePath, render: function () {
                        return title !== false ? (React.createElement(react_admin_1.Title, { title: title, defaultTitle: defaultTitle })) : null;
                    } })))));
};
exports.TreeWithDetails = TreeWithDetails;
