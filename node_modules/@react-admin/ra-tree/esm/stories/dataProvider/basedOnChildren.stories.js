...
var CategoriesListLazy = function (props) { return (React.createElement(TreeWithDetails, __assign({ titleField: "name", draggable: true, create: CategoriesCreate, edit: CategoriesEdit, allowMultipleRoots: true, lazy: true }, props))); };
export var Lazy = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: treeDataProvider, i18nProvider: i18nProvider, customReducers: { tree: tree } },
    React.createElement(Resource, { name: "categories", list: CategoriesListLazy }))); };
