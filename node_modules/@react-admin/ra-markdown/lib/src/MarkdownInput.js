...
var MarkdownInput = function (_a) {
    var fullWidth = _a.fullWidth, helperText = _a.helperText, label = _a.label, options = _a.options, resource = _a.resource, source = _a.source, rest = __rest(_a, ["fullWidth", "helperText", "label", "options", "resource", "source"]);
    var editorRef = react_1.useRef();
    var _b = react_admin_1.useInput(__assign({ source: source }, rest)), _c = _b.input, onChange = _c.onChange, value = _c.value, isRequired = _b.isRequired, meta = _b.meta;
    ...
    return (react_1.default.createElement(react_admin_1.Labeled, { fullWidth: fullWidth, isRequired: isRequired, label: label, meta: meta, resource: resource, source: source },
        react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(react_editor_1.Editor, __assign({ initialValue: value, ref: editorRef }, mergedOptions)),
            react_1.default.createElement(core_1.FormHelperText, { error: touched && (error || submitError) },
                react_1.default.createElement(react_admin_1.InputHelperText, { touched: touched, error: error || submitError, helperText: helperText })))));
};
...
exports.MarkdownInput.defaultProps = {
    fullWidth: true,
