...
var SimpleShowLayout = function (props) {
    ...
    if (loading)
        return null;
    return (React.createElement(react_admin_1.SimpleShowLayout, __assign({}, rest), react_1.Children.map(children, function (child) {
...
exports.SimpleShowLayout.propTypes = react_admin_1.SimpleShowLayout.propTypes;
