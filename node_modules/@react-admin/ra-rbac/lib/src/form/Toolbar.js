...
var Toolbar = function (props) {
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(core_1.Toolbar, __assign({ className: classnames_1.default(classes.toolbar, (_a = {},
            ...
            React.createElement("div", { className: classes.defaultToolbar },
                React.createElement(react_admin_1.SaveButton, { handleSubmitWithRedirect: handleSubmitWithRedirect || handleSubmit, disabled: disabled, invalid: invalid, redirect: redirect, saving: saving || validating, submitOnEnter: submitOnEnter }),
                record &&
                    ...
                    canAccess_1.canAccess({
                        ...
                        resource: resource,
                        record: record,
                    }) && (React.createElement(react_admin_1.DeleteButton, { basePath: basePath, record: record, resource: resource, undoable: undoable, mutationMode: mutationMode })))),
...
function useWidth() {
    ...
    return (keys.reduce(function (output, key) {
        ...
        var matches = useMediaQuery_1.default(theme.breakpoints.up(key));
