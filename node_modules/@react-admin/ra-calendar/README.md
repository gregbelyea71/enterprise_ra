...
![ra-calendar](./assets/ra-calendar.gif)

Test it live in [the Enterprise Edition Storybook](https://storybook.ra-enterprise.marmelab.com/?path=/story/ra-calendar-completecalendar--basic).

This module integrates [Full Calendar](https://fullcalendar.io/) with react-admin, and supports:
...
**Tip**: `ra-calendar` is part of the [React-Admin Enterprise Edition](https://marmelab.com/ra-enterprise/), and hosted in a private npm registry. You need to subscribe to one of the Enterprise Edition plans to access this package.
...
Check the possible values for `ListProps` in [the `<List>` component documentation](https://marmelab.com/react-admin/List.html#the-list-component).
