...
var usePreferences_1 = require("../src/usePreferences");
exports.default = { title: 'ra-preferences/Form' };
var PreferencesForm = function () {
    var _a = usePreferences_1.usePreferences(), preferences = _a[0], setPreferences = _a[1];
...
var ListWithDensity = function () {
    var preferences = usePreferences_1.usePreferences()[0];
...
var Preferences_Form = function () { return (react_1.default.createElement(core_1.Grid, { container: true, spacing: 2 },
    react_1.default.createElement(core_1.Grid, { item: true },
        react_1.default.createElement(ListWithDensity, null)),
    react_1.default.createElement(core_1.Grid, { item: true },
        react_1.default.createElement(PreferencesForm, null)))); };
exports.Preferences_Form = Preferences_Form;
