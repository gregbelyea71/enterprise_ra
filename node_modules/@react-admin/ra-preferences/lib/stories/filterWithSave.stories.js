...
var Basic = function () { return (react_1.default.createElement(react_admin_1.Admin, { dataProvider: dataProvider_1.default },
...
var WithThemeAndLocale = function () { return (react_1.default.createElement(src_1.PreferencesBasedThemeProvider, { themeFromType: function (type) { return themes[type]; } },
    react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), i18nProvider: i18nProvider, dataProvider: dataProvider_1.default, layout: MyLayout },
        react_1.default.createElement(react_admin_1.Resource, { name: "songs", list: SongList })))); };
exports.WithThemeAndLocale = WithThemeAndLocale;
