...
exports.useSelectedColumns = void 0;
var react_1 = require("react");
var usePreferences_1 = require("../usePreferences");
/**
...
var useSelectedColumns = function (_a) {
    ...
    var _b = usePreferences_1.usePreferences(preferences), columnsFromPrefs = _b[0], setColumnsFromPref = _b[1];
    ...
    var columnList = columnsFromPrefs
        ? columnsFromPrefs.filter(function (name) { return !!columns[name]; })
        : Object.keys(columns);
    return columnList.map(function (name) {
        return react_1.cloneElement(columns[name], __assign({ key: columns[name].key || name }, columns[name].props));
    });
};
exports.useSelectedColumns = useSelectedColumns;
