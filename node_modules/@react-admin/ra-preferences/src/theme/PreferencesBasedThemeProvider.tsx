import { useMemo, cloneElement, isValidElement, ReactNode } from 'react';
...
export interface PreferencesBasedThemeProviderProps {
    children: ReactNode;
 ...
 */
export const PreferencesBasedThemeProvider = ({
    children,
    themeFromType = defaultThemeFromType,
    ...rest
}: PreferencesBasedThemeProviderProps) => {
