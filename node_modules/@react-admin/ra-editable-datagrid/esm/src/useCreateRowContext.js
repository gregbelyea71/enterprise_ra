 ...
 *     };
 */
export var useCreateRowContext = function () {
    var context = useContext(CreateRowContext);
    if (!context && process.env.NODE_ENV === 'development') {
        console.error('useCreateRowContext cannot be called outside of the RowForm passed as the `createForm` of the <EditableDatagrid> row.');
    }
    return context;
};
