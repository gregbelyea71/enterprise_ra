...
import { Admin, Resource, List, TextField, TextInput, DateField, DateInput, SelectField, SelectInput, required, useNotify, } from 'react-admin';
import { createMemoryHistory } from 'history';
import { DeleteWithConfirmIconButton, EditableDatagrid, EditRowButton, RowForm, useCreateRowContext, useEditRowContext, } from '../src';
...
export var Slow = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: delayedDataProvider },
    React.createElement(Resource, { name: "artists", list: ArtistList }))); };
...
var ArtistListConfirmDelete = function (props) { return (React.createElement(List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    React.createElement(EditableDatagrid, { mutationMode: "pessimistic", undoable: true, createForm: React.createElement(ArtistForm, null), editForm: React.createElement(ArtistForm, null) },
        React.createElement(TextField, { source: "id" }),
        React.createElement(TextField, { source: "firstname" }),
        React.createElement(TextField, { source: "name" }),
        React.createElement(DateField, { source: "dob", label: "born" }),
        React.createElement(SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
export var ConfirmDelete = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: dataProvider },
    React.createElement(Resource, { name: "artists", list: ArtistListConfirmDelete }))); };
var CustomAction = function () { return (React.createElement(React.Fragment, null,
    React.createElement(EditRowButton, null),
    React.createElement(DeleteWithConfirmIconButton, { mutationMode: "undoable" }))); };
var ArtistListConfirmUndoableDelete = function (props) { return (React.createElement(List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    React.createElement(EditableDatagrid, { actions: React.createElement(CustomAction, null), mutationMode: "pessimistic", undoable: true, createForm: React.createElement(ArtistForm, null), editForm: React.createElement(ArtistForm, null) },
        React.createElement(TextField, { source: "id" }),
        React.createElement(TextField, { source: "firstname" }),
        React.createElement(TextField, { source: "name" }),
        React.createElement(DateField, { source: "dob", label: "born" }),
        React.createElement(SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
export var ConfirmUndoableDelete = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: dataProvider },
    React.createElement(Resource, { name: "artists", list: ArtistListConfirmUndoableDelete }))); };
...
var ArtistFormCreateSideEffect = function (props) {
    ...
    var close = useCreateRowContext().close;
    return (React.createElement(ArtistForm, __assign({}, props, { onSuccess: function (_a) {
            var record = _a.data;
...
var ArtistFormEditSideEffect = function (props) {
    var notify = useNotify();
    var close = useEditRowContext().close;
    return (React.createElement(ArtistForm, __assign({}, props, { onSuccess: function (_a) {
            var record = _a.data;
...
var ArtistListCustomSideEffects = function (props) {
    return (React.createElement(List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
        React.createElement(EditableDatagrid, { createForm: React.createElement(ArtistFormCreateSideEffect, null), editForm: React.createElement(ArtistFormEditSideEffect, null), rowClick: "edit" },
            React.createElement(TextField, { source: "id" }),
            React.createElement(TextField, { source: "firstname" }),
            React.createElement(TextField, { source: "name" }),
            React.createElement(DateField, { source: "dob", label: "born" }),
...
export var CustomSideEffects = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: dataProvider },
    React.createElement(Resource, { name: "artists", list: ArtistListCustomSideEffects }))); };
