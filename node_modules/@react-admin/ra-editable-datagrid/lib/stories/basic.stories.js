...
exports.CustomSideEffects = exports.RowClick = exports.NoDelete = exports.ConfirmUndoableDelete = exports.ConfirmDelete = exports.Undoable = exports.Slow = exports.Basic = void 0;
...
var Basic = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
...
var Slow = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: delayedDataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistList }))); };
exports.Slow = Slow;
var ArtistListUndoable = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    react_1.default.createElement(src_1.EditableDatagrid, { undoable: true, createForm: react_1.default.createElement(ArtistForm, null), editForm: react_1.default.createElement(ArtistForm, null) },
        ...
        react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
        react_1.default.createElement(react_admin_1.SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
var Undoable = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistListUndoable }))); };
exports.Undoable = Undoable;
var ArtistListConfirmDelete = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    react_1.default.createElement(src_1.EditableDatagrid, { mutationMode: "pessimistic", undoable: true, createForm: react_1.default.createElement(ArtistForm, null), editForm: react_1.default.createElement(ArtistForm, null) },
        react_1.default.createElement(react_admin_1.TextField, { source: "id" }),
        react_1.default.createElement(react_admin_1.TextField, { source: "firstname" }),
        react_1.default.createElement(react_admin_1.TextField, { source: "name" }),
        react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
        react_1.default.createElement(react_admin_1.SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
var ConfirmDelete = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistListConfirmDelete }))); };
exports.ConfirmDelete = ConfirmDelete;
var CustomAction = function () { return (react_1.default.createElement(react_1.default.Fragment, null,
    react_1.default.createElement(src_1.EditRowButton, null),
    react_1.default.createElement(src_1.DeleteWithConfirmIconButton, { mutationMode: "undoable" }))); };
var ArtistListConfirmUndoableDelete = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    react_1.default.createElement(src_1.EditableDatagrid, { actions: react_1.default.createElement(CustomAction, null), mutationMode: "pessimistic", undoable: true, createForm: react_1.default.createElement(ArtistForm, null), editForm: react_1.default.createElement(ArtistForm, null) },
        react_1.default.createElement(react_admin_1.TextField, { source: "id" }),
        react_1.default.createElement(react_admin_1.TextField, { source: "firstname" }),
        react_1.default.createElement(react_admin_1.TextField, { source: "name" }),
        react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
        react_1.default.createElement(react_admin_1.SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
var ConfirmUndoableDelete = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistListConfirmUndoableDelete }))); };
exports.ConfirmUndoableDelete = ConfirmUndoableDelete;
var ArtistListNoDelete = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    react_1.default.createElement(src_1.EditableDatagrid, { noDelete: true, createForm: react_1.default.createElement(ArtistForm, null), editForm: react_1.default.createElement(ArtistForm, null) },
        ...
        react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
        react_1.default.createElement(react_admin_1.SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
var NoDelete = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
...
var ArtistListRowClick = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
    react_1.default.createElement(src_1.EditableDatagrid, { createForm: react_1.default.createElement(ArtistForm, null), editForm: react_1.default.createElement(ArtistForm, null), rowClick: "edit" },
        ...
        react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
        react_1.default.createElement(react_admin_1.SelectField, { source: "prof", label: "Profession", choices: professionChoices })))); };
var RowClick = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistListRowClick }))); };
exports.RowClick = RowClick;
var ArtistFormCreateSideEffect = function (props) {
    var notify = react_admin_1.useNotify();
    var close = src_1.useCreateRowContext().close;
    return (react_1.default.createElement(ArtistForm, __assign({}, props, { onSuccess: function (_a) {
            var record = _a.data;
            notify("Artist " + record.name + " has been added");
            close();
        } })));
};
var ArtistFormEditSideEffect = function (props) {
    var notify = react_admin_1.useNotify();
    var close = src_1.useEditRowContext().close;
    return (react_1.default.createElement(ArtistForm, __assign({}, props, { onSuccess: function (_a) {
            var record = _a.data;
            notify("Artist " + record.name + " has been updated");
            close();
        } })));
};
var ArtistListCustomSideEffects = function (props) {
    return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
        react_1.default.createElement(src_1.EditableDatagrid, { createForm: react_1.default.createElement(ArtistFormCreateSideEffect, null), editForm: react_1.default.createElement(ArtistFormEditSideEffect, null), rowClick: "edit" },
            react_1.default.createElement(react_admin_1.TextField, { source: "id" }),
            react_1.default.createElement(react_admin_1.TextField, { source: "firstname" }),
            react_1.default.createElement(react_admin_1.TextField, { source: "name" }),
            react_1.default.createElement(react_admin_1.DateField, { source: "dob", label: "born" }),
...
var CustomSideEffects = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider },
    react_1.default.createElement(react_admin_1.Resource, { name: "artists", list: ArtistListCustomSideEffects }))); };
exports.CustomSideEffects = CustomSideEffects;
