...
var useSearch = function (defaultOptions) {
    ...
    var doSearch = function (query, options) {
        ...
        dataProvider
            ...
            setState(function (prev) { return (__assign(__assign({}, prev), { query: query, data: data, total: total, loading: false, history: updateHistory(prev.history, query, total, options && options.historySize
                    ? options.historySize
                    : (defaultOptions || {}).historySize), loaded: true })); });
        })
            .catch(function (error) {
            setState(function (prev) { return (__assign(__assign({}, prev), { query: query, error: error, loading: false })); });
        });
    };
