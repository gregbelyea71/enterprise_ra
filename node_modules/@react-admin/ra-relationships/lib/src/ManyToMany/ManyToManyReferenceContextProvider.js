 ...
 * updates.
 */
var ManyToManyReferenceContextProvider = function (_a) {
    ...
    return (React.createElement(ManyToManyReferenceContext_1.ManyToManyReferenceContext.Provider, { value: value },
        React.createElement(react_admin_1.SaveContextProvider, { value: newSaveContext }, React.isValidElement(children)
            ? React.cloneElement(children, __assign(__assign(__assign({}, props), children.props), { save: save, saving: saveContext.saving, resource: resource, basePath: basePath }))
            : children)));
};
exports.ManyToManyReferenceContextProvider = ManyToManyReferenceContextProvider;
