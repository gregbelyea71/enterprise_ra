...
var LoadedWithData = function (_a) {
    var resource = _a.resource, source = _a.source, reference = _a.reference, through = _a.through, using = _a.using;
    return (react_1.default.createElement(ra_test_1.TestContext, { initialState: initialState },
        react_1.default.createElement(src_1.ReferenceManyToManyField, { resource: resource, source: source, reference: reference, through: through, using: using, label: "performances", record: data_1.default.bands[0] },
