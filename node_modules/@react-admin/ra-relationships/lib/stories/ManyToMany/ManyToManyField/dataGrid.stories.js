...
var LoadedWithData = function () { return (react_1.default.createElement(core_1.ThemeProvider, { theme: core_1.createMuiTheme(react_admin_1.defaultTheme) },
...
exports.LoadedWithData = LoadedWithData;
var EmptyState = {
    admin: {
        references: {
            oneToMany: {
...
var NotLoadedYet = function () { return (react_1.default.createElement(core_1.ThemeProvider, { theme: core_1.createMuiTheme(react_admin_1.defaultTheme) },
...
var WithError = function () { return (react_1.default.createElement(core_1.ThemeProvider, { theme: core_1.createMuiTheme(react_admin_1.defaultTheme) },
    react_1.default.createElement(ra_test_1.TestContext, { initialState: EmptyState },
