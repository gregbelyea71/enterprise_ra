...
export var LoadedWithData = function (_a) {
    var resource = _a.resource, source = _a.source, reference = _a.reference, through = _a.through, using = _a.using;
    return (React.createElement(ThemeProvider, { theme: createMuiTheme(defaultTheme) },
                ...
                React.createElement(Edit, { id: "1", basePath: "/bands", resource: "bands" },
                    React.createElement(ManyToManyReferenceContextProvider, null,
                        React.createElement(SimpleForm, null,
                            React.createElement(ReferenceManyToManyInput, { resource: resource, source: source, reference: reference, through: through, using: using, label: "performances", record: data.bands[0] },
