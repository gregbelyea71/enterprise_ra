...
exports.useGetActionLink = useGetActionLink;
var getActionLink = function (resources, record, linkType) {
    var _a;
    var resource = resources.find(function (r) { return r.name === record.resource; });
    // When a user logs out, resources are not available anymore.
    if (!resource) {
        return undefined;
    }
...
exports.getActionLink = getActionLink;
