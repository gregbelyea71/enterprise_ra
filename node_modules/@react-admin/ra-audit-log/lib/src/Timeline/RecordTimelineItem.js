 ...
 * @see Timeline
 */
var RecordTimelineItem = function (props) {
    ...
    var actionLabel = useEventLabel_1.useEventLabel({ record: record, variant: 'record' });
    if (!record) {
        return null;
    }
    return (React.createElement(core_1.ListItem, __assign({ className: classnames_1.default(classes.root, className), button: false, dense: true, disableGutters: true }, rest),
        React.createElement(core_1.ListItemText, { primary: React.createElement("div", { className: classes.authorContainer },
                React.createElement(EventAvatar_1.EventAvatar, { className: classes.avatar, alt: record.author.fullName, src: record.author.avatar, fullName: record.author.fullName, role: "presentation", size: "small" }),
...
exports.RecordTimelineItem = RecordTimelineItem;
