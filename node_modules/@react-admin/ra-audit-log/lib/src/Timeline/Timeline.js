...
var Timeline = function (props) {
    var _a = props.children, children = _a === void 0 ? React.createElement(TimelineGroup_1.TimelineGroup, null) : _a, _b = props.groupLogs, groupLogs = _b === void 0 ? groupByDay_1.groupByDay : _b, loaded = props.loaded, _c = props.records, records = _c === void 0 ? [] : _c, skeletonItems = props.skeletonItems, _d = props.skeleton, skeleton = _d === void 0 ? React.createElement(TimelineSkeleton_1.TimelineSkeleton, { length: skeletonItems || 10 }) : _d;
