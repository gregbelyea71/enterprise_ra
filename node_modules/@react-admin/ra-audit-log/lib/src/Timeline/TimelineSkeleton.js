...
var TimelineSkeleton = function (props) {
        ...
        React.createElement("div", null, times(2, function (key1) { return (React.createElement("div", { key: key1 },
            ...
            React.createElement(core_1.Card, { className: classes.card },
                React.createElement(core_1.List, null, times(5, function (key2) { return (React.createElement(core_1.ListItem, { key: key2 },
                    ...
                    React.createElement(core_1.ListItemText, { primary: React.createElement(TimelinePlaceholder_1.TimelinePlaceholder, { className: classes.text }), secondary: React.createElement(TimelinePlaceholder_1.TimelinePlaceholder, { className: classes.text }) }))); }))))); }))));
};
