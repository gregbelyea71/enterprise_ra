...
var RecordTimelineSkeleton_1 = require("./RecordTimelineSkeleton");
 ...
 * }
 */
var RecordTimeline = function (props) {
    var _a = dataProvider_1.useRecordEvents(props), loaded = _a.loaded, data = _a.data, ids = _a.ids;
    var page = props.page, perPage = props.perPage, sort = props.sort, order = props.order, record = props.record, resource = props.resource, skeletonItems = props.skeletonItems, _b = props.skeleton, skeleton = _b === void 0 ? React.createElement(RecordTimelineSkeleton_1.RecordTimelineSkeleton, { length: skeletonItems || 10 }) : _b, rest = __rest(props, ["page", "perPage", "sort", "order", "record", "resource", "skeletonItems", "skeleton"]);
    ...
    return (React.createElement(Timeline_1.Timeline, __assign({ loaded: loaded, records: ids.map(function (id) { return data[id]; }), skeleton: skeleton }, rest),
