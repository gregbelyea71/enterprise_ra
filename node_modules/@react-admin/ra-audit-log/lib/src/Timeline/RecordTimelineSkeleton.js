...
exports.RecordTimelineSkeleton = void 0;
...
var RecordTimelineSkeleton = function (props) {
            ...
            React.createElement(core_1.Card, { className: classes.card },
                React.createElement(core_1.List, null, times(5, function (key2) { return (React.createElement(core_1.ListItem, { key: key2 },
                    React.createElement(core_1.ListItemText, { primary: React.createElement("div", { className: classes.authorContainer },
                            React.createElement(EventAvatar_1.EventAvatar, { className: classes.avatar, size: "small" }),
                            React.createElement(TimelinePlaceholder_1.TimelinePlaceholder, { className: classes.text })), secondary: React.createElement(TimelinePlaceholder_1.TimelinePlaceholder, { className: classes.text }) }))); }))))); }))));
};
exports.RecordTimelineSkeleton = RecordTimelineSkeleton;
