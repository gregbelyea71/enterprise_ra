 ...
 * };
 */
var TimelineGroup = function (props) {
    ...
    return (React.createElement("div", { className: classnames_1.default(classes.root, className) },
        ...
        React.createElement(core_1.List, { component: "div", role: "list", "aria-label": translatedLabel, dense: true, className: classes.events }, records.map(function (record) { return (React.createElement(react_admin_1.RecordContextProvider, { key: record.id, value: record }, children)); }))));
};
