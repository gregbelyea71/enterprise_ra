...
var NotLoadedYet = function () { return (React.createElement(React.Fragment, null,
...
exports.NotLoadedYet = NotLoadedYet;
var records = [
    {
        id: 1,
        resource: 'products',
...
var Loaded = function () { return (React.createElement(react_redux_1.Provider, { store: store },
...
var CustomGrouping = function () { return (React.createElement(react_redux_1.Provider, { store: store },
    React.createElement(react_router_1.MemoryRouter, null,
        React.createElement(core_1.Box, { bgcolor: "background.default", padding: 2 },
            React.createElement(core_1.Container, { maxWidth: "sm" },
                React.createElement(react_admin_1.TranslationProvider, { locale: "en", i18nProvider: i18nProvider },
...
var CustomGroupComponent = function () { return (React.createElement(react_redux_1.Provider, { store: store },
    React.createElement(react_router_1.MemoryRouter, null,
        React.createElement(core_1.Box, { bgcolor: "background.default", padding: 2 },
            React.createElement(core_1.Container, { maxWidth: "sm" },
                React.createElement(react_admin_1.TranslationProvider, { locale: "en", i18nProvider: i18nProvider },
...
exports.CustomGroupComponent = CustomGroupComponent;
...
var CustomItemComponent = function () { return (React.createElement(react_redux_1.Provider, { store: store },
    React.createElement(react_router_1.MemoryRouter, null,
        React.createElement(core_1.Box, { bgcolor: "background.default", padding: 2 },
            React.createElement(core_1.Container, { maxWidth: "sm" },
                React.createElement(react_admin_1.TranslationProvider, { locale: "en", i18nProvider: i18nProvider },
...
exports.CustomItemComponent = CustomItemComponent;
