...
var Basic = function () { return (React.createElement(react_admin_1.Admin, { dataProvider: dataProvider, i18nProvider: i18nProvider, history: history },
...
var WithAuthorsAsResource = function () { return (React.createElement(react_admin_1.Admin, { dataProvider: dataProvider, i18nProvider: i18nProvider, history: history },
    ...
    React.createElement(react_admin_1.Resource, { name: "orders" }),
    React.createElement(react_admin_1.Resource, { name: "reviews" }))); };
exports.WithAuthorsAsResource = WithAuthorsAsResource;
