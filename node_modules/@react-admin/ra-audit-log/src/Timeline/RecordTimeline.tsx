...
export const RecordTimeline = (props: RecordTimelineProps): ReactElement => {
    ...
    const {
        ...
        resource,
        skeletonItems,
        skeleton = <RecordTimelineSkeleton length={skeletonItems || 10} />,
        ...rest
    } = props;

    if (skeletonItems != null && process.env.NODE_ENV === 'development') {
        console.warn(
            `The skeletonItems prop is deprecated. You should provide the skeleton prop instead to customize the number of items displayed.
