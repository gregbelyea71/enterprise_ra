...
import { RecordTimelineSkeleton } from './RecordTimelineSkeleton';
...
export var RecordTimeline = function (props) {
    ...
    var page = props.page, perPage = props.perPage, sort = props.sort, order = props.order, record = props.record, resource = props.resource, skeletonItems = props.skeletonItems, _b = props.skeleton, skeleton = _b === void 0 ? React.createElement(RecordTimelineSkeleton, { length: skeletonItems || 10 }) : _b, rest = __rest(props, ["page", "perPage", "sort", "order", "record", "resource", "skeletonItems", "skeleton"]);
    ...
    return (React.createElement(Timeline, __assign({ loaded: loaded, records: ids.map(function (id) { return data[id]; }), skeleton: skeleton }, rest),
