export var raAuditLogLanguageFrench = {
    'ra-audit-log': {
        ...
        record_event: {
            create: 'A créé cette resource',
            delete: 'A supprimé cette resource',
            update: 'A modifié le champs %{fields} |||| A modifié les champs %{fields}',
        },
        record_many_fields_events: {
            create: 'A créé cette resource',
            delete: 'A supprimé cette resource',
            update: 'A modifié les champs %{fields} et 1 autre |||| A modifié les champs %{fields} et %{smart_count} autres',
        },
        author: '{fullName}',
        period_filters: {
            today: "Aujourd'hui",
