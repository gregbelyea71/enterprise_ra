...
var PostCreate = function (props) { return (React.createElement(Create, __assign({}, props),
    React.createElement(WizardForm, null,
        ...
        React.createElement(WizardFormStep, { label: "" },
            React.createElement(FormSpy, { subscription: { values: true } }, function (props) { return (React.createElement(React.Fragment, null,
...
var PostCreateWithSummary = function (props) { return (React.createElement(Create, __assign({}, props),
    React.createElement(WizardForm, null,
        React.createElement(WizardFormStep, { label: "First step" },
            React.createElement(TextInput, { source: "title", validate: required() })),
        React.createElement(WizardFormStep, { label: "Second step" },
        ...
        React.createElement(WizardFormStep, { label: "" },
            React.createElement(FormSpy, { subscription: { values: true } }, function (props) { return (React.createElement(React.Fragment, null,
                ...
                React.createElement(Typography, null,
                    "fullDescription: ",
                    props.values.fullDescription))); }))))); };
export var WithSummaryStep = function () { return (React.createElement(Admin, { history: createMemoryHistory(), i18nProvider: i18nProvider, dataProvider: dataProvider },
