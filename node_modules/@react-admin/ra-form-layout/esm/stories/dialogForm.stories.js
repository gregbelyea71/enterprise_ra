...
var CustomerListDialogs = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(CreateDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md" },
            React.createElement(CustomerForm, null)),
        React.createElement(EditDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md" },
            React.createElement(CustomerForm, null))));
};
...
var CustomerListDialogsWithTitles = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(CustomerList, __assign({}, props)),
        React.createElement(CreateDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md", title: "Create a new customer" },
            React.createElement(CustomerForm, null)),
        React.createElement(EditDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md", title: React.createElement(EditDialogTitle, null) },
            React.createElement(CustomerForm, null))));
};
