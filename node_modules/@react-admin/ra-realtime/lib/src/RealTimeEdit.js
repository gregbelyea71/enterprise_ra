...
var RealTimeEdit = function (_a) {
    ...
    dataProvider_1.useSubscribeToRecord(resource, id, function (event) {
        return onEventReceived(event, {
            setDeleted: setDeleted,
            setUpdated: setUpdated,
            setUpdatedDisplayed: setUpdatedDisplayed,
        });
    });
    return (React.createElement(React.Fragment, null,
        React.createElement(core_1.Collapse, { in: deleted || updatedDisplayed },
            deleted && (React.createElement(Warning_1.Warning, { message: translate('ra-realtime.notification.record.deleted') })),
            updated && (React.createElement(Warning_1.Warning, { message: translate('ra-realtime.notification.record.updated'), refresh: true, onRefresh: function () {
...
exports.RealTimeEdit = RealTimeEdit;
var defaultHandleEventReceived = function (event, _a) {
    var setUpdated = _a.setUpdated, setUpdatedDisplayed = _a.setUpdatedDisplayed, setDeleted = _a.setDeleted;
