...
var RealTimeShow = function (_a) {
    ...
    dataProvider_1.useSubscribeToRecord(resource, id, function (event) {
        return onEventReceived(event, { setDeleted: setDeleted });
    });
    return (React.createElement(React.Fragment, null,
        React.createElement(core_1.Collapse, { in: deleted }, deleted && (React.createElement(Warning_1.Warning, { message: translate('ra-realtime.notification.record.deleted') }))),
        React.createElement(react_admin_1.Show, __assign({ resource: resource, id: id }, rest), children)));
};
exports.RealTimeShow = RealTimeShow;
