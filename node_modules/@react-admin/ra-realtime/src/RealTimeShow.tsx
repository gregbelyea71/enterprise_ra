...
export const RealTimeShow = ({
    ...
    const defaultHandleEventReceived: ShowSubscriptionCallback<RecordEvent> =
        event => {
    ...
    useSubscribeToRecord(resource, id, event =>
        onEventReceived(event, { setDeleted })
    );
    return (
        <>
            <Collapse in={deleted}>
