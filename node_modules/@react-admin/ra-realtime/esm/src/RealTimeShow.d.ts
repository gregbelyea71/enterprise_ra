...
export declare type ShowSubscriptionStateSetter = {
    setDeleted: (value: boolean) => void;
};
export declare type ShowSubscriptionCallback<T = Event> = (event: T, subscriptionStateSetters: ShowSubscriptionStateSetter) => void;
export interface RealTimeShowProps extends ShowProps {
    onEventReceived?: ShowSubscriptionCallback<RecordEvent>;
}
//# sourceMappingURL=RealTimeShow.d.ts.map